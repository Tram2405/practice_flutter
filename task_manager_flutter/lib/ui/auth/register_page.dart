    ...
    return GestureDetector(
      ...
      child: TMScaffold(
        body: Padding(
          ...
          child: ListView(
            children: [
              TMTitle(title: S.of(context).txtRegister),
              const SizedBox(height: 16.0),
              TMTitle(
                title: S.of(context).txtTitleRegister,
                textStyle: context.textTheme.titleLarge
                    ?.copyWith(color: TMColor.onSecondaryBackground),
              ),
              sizedBox32,
              TMTextFormField(
                hintText: S.of(context).txtHintName,
                lableText: S.of(context).txtFullName,
              ...
              TMTextFormFieldPassword(
                ...
                hintText: S.of(context).txtHintRetypePassword,
              ...
              sizedBox32,
              TMTextLink(
                text: S.of(context).txtLableRegister,
                linkText: S.of(context).txtLoginHere,
                onPressed: () {
